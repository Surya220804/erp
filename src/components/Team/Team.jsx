    ...
    <section className='team'>
        <div className="container">
            <div className="title">
                ...
                <p>Get to know the passionate experts dedicated to creating seamless experiences and delivering outstanding support for your institution.</p>
            </div>
            ...
            <div className="career-grid">
                ...
                <div className="career-grid-item">
                    <p>Become part of a forward-thinking group committed to transforming education through innovation. Work alongside talented professionals, grow your skills, and contribute to meaningful solutions that support schools worldwide.</p>
